                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg clickable-item" data-uid="{{ $location->uid }}">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <h6 class="mb-3 text-sm">{{ $location->distance }}</h6>
                                <span class="mb-2 text-xs">Quarry Id: <span class="text-dark font-weight-bold ms-sm-2">{{ $location->uid }}</span></span>
                                ...
                                <form action="{{ route('drop-quarry') }}" id="myForm" method="POST" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <span class="mb-2 text-xs">Your Quantity in Unit : <span class="text-dark font-weight-bold ms-sm-2">{{ $location->quantity }}</span></span>
